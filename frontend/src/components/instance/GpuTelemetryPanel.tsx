    ...
    <div className="rounded-2xl border border-white/8 bg-[#141414] p-5">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <div className="rounded-2xl border border-white/6 bg-black/20 p-4">
          ...
          <p className="mt-3 text-3xl font-semibold text-white">{gpu.vram_percent}%</p>
        ...
        <div className="rounded-2xl border border-white/6 bg-black/20 p-4">
          ...
          <p className="mt-3 text-3xl font-semibold text-white">{gpu.utilization}%</p>
        ...
        <div className="rounded-2xl border border-white/6 bg-black/20 p-4">
          ...
          <p className="mt-3 text-3xl font-semibold text-white">{gpu.temp_c.toFixed(1)}°C</p>
          <p className="mt-2 text-sm text-muted-foreground">{gpu.power_w.toFixed(1)} W</p>
        </div>
        <div className="rounded-2xl border border-white/6 bg-black/20 p-4">
